...
var clickHandler = function () {
	var songNumber = parseInt($(this).attr('data-song-number'));
	  ///moved var songnumber from this row
...
// ********* start experiment
 var nearbySong = function(nextPrevString) {
   switch (nextPrevString) {
		case "nextSong": 
   ...
   // this wraps around from the first and last song
    if (currentSongIndex >= currentAlbum.songs.length) {currentSongIndex = 0;}    //next
	 if (currentSongIndex < 0) {currentSongIndex = currentAlbum.songs.length - 1;} //prev
...
$(document).ready(function () {
	...
	$previousButton.click(nearbySong("previousSong"));
   $nextButton.click(nearbySong("nextSong"));
}); //end doc ready